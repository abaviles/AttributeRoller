...
const defaultAttScores = [15, 14, 13, 12, 10, 8]

class Player {
    constructor(characterName = 'Goku') {
        ...
        let shuffledResult = shuffleArray(defaultAttScores);
...
const player02 = new Player('Mr. Vegeta');
...
//shorthand way: return array.reduce((total, currentNumber) => total + currentNumber);